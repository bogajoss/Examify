...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:scale-110",
  {
    variants: {
      variant: {
        default:
        ...
        outline: "text-foreground hover:shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
